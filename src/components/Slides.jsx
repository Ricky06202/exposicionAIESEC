...
export const SectionsSlide = () => {
  ...
  return (
    <div className="max-w-6xl w-full px-6 pt-20 pb-8 flex flex-col lg:flex-row gap-10 items-start overflow-y-auto max-h-[85vh]">
...
export const TypesSlide = () => {
    ...
    return (
        <div className="max-w-6xl w-full px-6 flex flex-col items-center pt-20 pb-12 overflow-y-auto max-h-[90vh]">
...
export const FoodHeroSlide = () => {
  ...
  return (
    <div className="max-w-6xl w-full px-6 pt-20 pb-8 flex flex-col lg:flex-row gap-8 items-start overflow-y-auto max-h-[90vh]">
      <div className="flex-1 text-left lg:sticky lg:top-0">
...
export const StackSlide = () => (
  <div className="max-w-5xl w-full px-6 flex flex-col items-center overflow-y-auto max-h-[85vh] pt-20 pb-12">
